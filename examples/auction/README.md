# Auction board contract and DApp

This example implements a simple one-item auction. It allows
...
The full description of the auction scenario, as well as a
detailed discussion of the code, can be found in part 3 of the
Midnight developer tutorial.

The `auction-tutorial` directory contains a version of the bulletin
...
in the `auction-tutorial` directory, **do not expect the code to
compile until after you have completed the tutorial**.

The `auction` directory contains the solution to the problems posed in
the tutorial. You can think of it as the answer key to the
`auction-tutorial` example. If you are reading this in the `auction`
