/*
 * This file is the main driver for the Midnight auction example.
 ...
 * the data on the ledger, for a specific auction contract.
 ...
 * by the contract to be in the ledger state of the auction.
 */
...
const displayPrivateState = async (providers: AuctionProviders, logger: Logger): Promise<void> => {
  ...
  if (privateState === null) {
    logger.info(`There is no existing auction private state`);
  } else {
...
/* **********************************************************************
 * mainLoop: the main interactive menu of the auction CLI.
...
/* **********************************************************************
 * run: the main entry point that starts the whole auction CLI.
 *
